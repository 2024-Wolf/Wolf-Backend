                ...
                <%@ include file="sidebar.jsp" %>
                    <div class="infoCard">
                        <div class="inputGroup">
                            ...
                            <span class="buttonSideContainer">
                                <button class="formButton linePurpleButton displayNone"
                                    onclick="location.href='/noticeEdit'"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <button class="formButton darkBackgroundButton displayNone"
                                    onclick="alert('삭제완료'); location.href='/notice'"><svg
                        ...
                        <div class="buttonSideContainer displayFlex">
                            <button class="formButton linePurpleButton" onclick="location.href='/noticeEdit'"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
