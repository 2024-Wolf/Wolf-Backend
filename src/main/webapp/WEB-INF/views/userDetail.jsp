                    ...
                    <div class="infoCard">
                        <div class="inputGroup">
                            ...
                            <span class="buttonSideContainer">
                                <button class="formButton noBackgroundButton" onclick="location.href='/notice'"><svg
                        ...
                        <div class="inputSection">
                            ...
                            <div class="inputGroup">
                                ...
                                <label for="percentage-slider"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                        height="16" fill="currentColor" class="bi bi-emoji-laughing"
                                        viewBox="0 0 16 16">
                                ...
                                <input type="range" id="percentage-slider" name="percentage" min="0" max="100"
                                    value="50" oninput="updateSliderValue(this.value)" disabled />
                                <label for="percentage-slider"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                        height="16" fill="currentColor" class="bi bi-emoji-neutral" viewBox="0 0 16 16">
                                        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16" />
                                        <path
