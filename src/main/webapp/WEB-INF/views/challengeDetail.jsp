                ...
                <%@ include file="sidebar.jsp" %>
                    <div class="infoCard">
                        <div class="inputGroup">
                            ...
                            <span class="buttonSideContainer">
                                <button class="formButton linePurpleButton displayNone"
                                    onclick="location.href='/challengeEdit'"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <button class="formButton noBackgroundButton" onclick="location.href='/challenge'"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <div class="buttonSideContainer displayFlex">
                            <button class="formButton linePurpleButton" onclick="location.href='/challengeEdit'"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <div class="inputSection scrollArea">
                            <div class="inputGroup">
                                ...
                                <input class="textContent input" type="radio" name="auth" id="system" disabled>
                                <label for="system">시스템</label>
                                <input class="textContent input" type="radio" name="auth" id="manager" disabled>
