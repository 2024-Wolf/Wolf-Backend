				...
				<%@ include file="components/sidebar.jsp" %>
					<div class="infoCard">
						...
						<jsp:include page="components/button/editDeleteButton.jsp">
							<jsp:param name="challenge_id" value="${challenge.challengePostId}"/>
						</jsp:include>
						<div class="inputSection scrollArea">
							...
							<jsp:include page="components/inputDate/startEndDate.jsp">
								<jsp:param name="startDate" value="${challenge.registrationDate}" />
								<jsp:param name="endDate" value="${challenge.deadline}" />
							</jsp:include>
