    ...
    public List<GroupPostEntity> insertGroupPostData(List<UserEntity> users) {
        List<GroupPostEntity> groupPosts = Arrays.asList(
                ...
                new GroupPostEntity(
                        ...
                        "Spring Boot에 대한 심화 학습을 진행합니다.", "학습 태도에 문제가 있을 시 제외됩니다.", 'A'),
                ...
                new GroupPostEntity(
                        ...
                        "주 2회 알고리즘 문제풀이를 진행합니다.", "문제풀이에 소홀할 시 제외됩니다.", 'B'),
                ...
                new GroupPostEntity(
                        ...
                        "데이터베이스 모델링 및 실습을 진행합니다.", "수업을 무단으로 빠질 시 제외됩니다.", 'C'),
                ...
                new GroupPostEntity(
                        ...
                        "React 기본과 실습을 병행합니다.", "소통이 부족할 시 제외됩니다.", 'D'),
                ...
                new GroupPostEntity(
                        ...
                        "추천 시스템을 설계하고 구현하는 프로젝트입니다.", "프로젝트에 소홀할 시 제외됩니다.", 'A'),
                ...
                new GroupPostEntity(
                        ...
                        "Java와 Spring을 사용한 웹 애플리케이션 개발 프로젝트입니다.", "지속적인 참여가 필요합니다.", 'B'),
                ...
                new GroupPostEntity(
                        ...
                        "Android 스튜디오를 사용하여 앱을 개발합니다.", "코드 품질을 유지해야 합니다.", 'C'),
                ...
                new GroupPostEntity(
                        ...
                        "AWS 기반의 인프라를 설계하고 구축하는 프로젝트입니다.", "안전한 시스템 설계가 요구됩니다.", 'D')
        );
